        ...
        <?php 
            ...
            if($permissao == 3) {
                ...
                if($cod_tipo == 1) {
                    ...
                    include_once "view-video-content.php";

                }

                if($cod_tipo == 2) {

                    include_once "view-text-content.php";

                }

                if($cod_tipo == 3) {

                    include_once "view-file-content.php";

                }

                if($cod_tipo == 4) {

                    include_once "view-link-content.php";

                }

                if($cod_tipo == 5 && $cod_tipo_avaliacao == 1) {

                    include_once "view-exercise-content.php"; 

                }

                if($cod_tipo == 5 && $cod_tipo_avaliacao == 2) {

                    include_once "view-test-content.php"; 
