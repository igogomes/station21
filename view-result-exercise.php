                    ...
                    <div class="ibox-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 ml-sm-auto" style="padding-top: 70px; padding-bottom: 70px; text-align: center;"> 
                                <span style="font-size: 75px; border: 5px solid <?php if($ultima_nota_exercicio >= 0 && $ultima_nota_exercicio <= 4) { echo "#E74C3C;"; } else if($ultima_nota_exercicio > 4 && $ultima_nota_exercicio < 7) { echo "#F39C12;"; } else { echo "#2ECC71;"; } ?> border-radius: 50%; <?php if(strlen($ultima_nota_exercicio) == 1) { echo "padding: 20px 50px;"; } else { echo "padding: 20px 30px;"; } ?> color: <?php if($ultima_nota_exercicio >= 0 && $ultima_nota_exercicio <= 4) { echo "#E74C3C;"; } else if($ultima_nota_exercicio > 4 && $ultima_nota_exercicio < 7) { echo "#F39C12;"; } else { echo "#2ECC71;"; } ?>"><?php echo $ultima_nota_exercicio; ?></span>
                            </div>
                        </div>
                        <div class="form-group row">
