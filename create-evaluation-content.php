<?php 
    ...
    $erro_cadastro_avaliacao = (isset($_GET["erro-evaluation"])) ? $_GET["erro-evaluation"] : "";
...
<head>
    ...
    <title>Cadastrar Avaliação | Station21</title>
    ...
    <div class="page-wrapper">
        ...
        <?php 
            ...
            if($permissao == 1) {
                ...
                include_once "form-create-evaluation-content.php";
