<?php 
    ...
    $titulo_categoria = (isset($_POST["titulo"])) ? $_POST["titulo"] : "";
    $erro_categoria = 0;
    $sucesso_cadastro_categoria = 0;

    if($titulo_categoria != "") {

        $verificar_categoria_existente = new GerenciarCategoria();
        $verificar_categoria_existente = $verificar_categoria_existente -> verificarCategoriaExistente($titulo_categoria);
        ...
        if($verificar_categoria_existente != 0) {
            ...
            $cadastrar_categoria = new GerenciarCategoria();
            $cadastrar_categoria = $cadastrar_categoria -> setCategoria($titulo_categoria);

            $sucesso_cadastro_categoria = 1;
...
<head>
    ...
    <title>Cadastrar Categoria | Station21</title>
