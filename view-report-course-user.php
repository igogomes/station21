<?php 
    ...
    $presenca_curso = new GerenciarPresenca();
    $presenca_curso = $presenca_curso -> getPresencaPorCodigoUsuarioECodigoCurso($cod_usuario, $cod_curso);
...
<head>
    ...
    <title>Relatório do Curso de <?php echo $titulo_curso; ?> | Station21</title>
    ...
    <div class="page-wrapper">
        ...
        <?php 
            ...
            if($permissao == 1) {
                ...
                include_once "data-base-reports-course-user.php";
