...
<!--<![endif]-->
    ...
    <head>
        ...
        <meta name="description" content="Site Portfolio Igo Gomes | Programador | Web Designer | Sites">
  	    <meta name="author" content="Igo Gomes">
		    <title>Perdeu-se no espaço? | Station21</title>
  	    <meta name="viewport" content="width=device-width, initial-scale=1">
  	    <link rel="shortcut icon" type="image/x-icon" href="images/logo_igo_gomes_favicon.jpg" />
        ...
        <link rel="stylesheet" href="./assets/css/pages/style-404.css"> 
    </head>
    ...
    <body class="permission_denied">
        ...
        <script src="assets/js/style-404.js" type="text/javascript"></script>
